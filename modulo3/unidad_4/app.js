...
app.use(session({
  secret: 'adiubaiudabdiuabdubaiduad',
  resave: false,
...
app.use(function (req,res,next){
  // si no existe la variable de sesison vistas la
  // la creamos como un objeto vacio
  if (!req.session.visitas){
    req.session.visitas = {};
  }
  /**
   * buscamos una blave dentro session.visitas que
   * coincida con la url actual. Si no existe, la
   * inicializamos en . Si existe sumamos  al contador
   * de esa ruta
   */
